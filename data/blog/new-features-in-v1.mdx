...
Line highlighting and line numbers are now supported out of the box thanks to the new [rehype-prism-plus plugin](https://github.com/wisnuary15/rehype-prism-plus)
...
See [rehype-citation readme](https://github.com/wisnuary15/rehype-citation) for more information on the configuration options.
...
```bash
git remote add template git@github.com:wisnuary15/tailwind-nextjs-starter-blog.git
git pull template v1 --allow-unrelated-histories
rm -rf node_modules
```

You can see an example of such a migration in this [commit](https://github.com/wisnuary15/wisnuary15.com/commit/bba1c185384fd6d5cdaac15abf802fdcff027286) for my personal blog.
