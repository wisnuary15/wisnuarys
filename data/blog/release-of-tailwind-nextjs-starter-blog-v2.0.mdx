...
To solve this, I have abstracted the logic to a separate repository - [Pliny](https://github.com/wisnuary15/pliny). Pliny provides out of the box Next.js components to enhance static sites:
...
I hope you enjoy the new features and improvements in V2. If you have any feedback or suggestions, feel free to open an issue or reach out to me on [Twitter](https://twitter.com/wisnuary15).
